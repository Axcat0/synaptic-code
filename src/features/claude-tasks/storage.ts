...
import type { SynapticCodeConfig } from "../../config/schema"

export function getTaskDir(config: Partial<SynapticCodeConfig> = {}): string {
...
export function resolveTaskListId(config: Partial<SynapticCodeConfig> = {}): string {
...
export function listTaskFiles(config: Partial<SynapticCodeConfig> = {}): string[] {
