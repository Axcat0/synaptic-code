...
import type { SynapticCodeConfig } from "../../config"
...
const isAgentDisabled = (agentConfigKey: string, config: SynapticCodeConfig): boolean => {
...
const pickFallbackAgent = (config: SynapticCodeConfig): CoreAgentKey => {
...
export const resolveRunAgent = (
  options: RunOptions,
  pluginConfig: SynapticCodeConfig,
