...
describe("disabled_mcps schema", () => {
  test("should accept built-in MCP names", () => {
    ...
    // when
    const result = SynapticCodeConfigSchema.safeParse(config)
...
describe("SynapticCodeConfigSchema - browser_automation_engine", () => {
  test("accepts browser_automation_engine config", () => {
    ...
    // when
    const result = SynapticCodeConfigSchema.safeParse(input)
...
describe("SynapticCodeConfigSchema - hashline_edit", () => {
