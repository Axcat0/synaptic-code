...
export const SynapticCodeConfigSchema = z.object({
  $schema: z.string().optional(),
  /** Enable new task system (default: false) */
  new_task_system_enabled: z.boolean().optional(),
  /** Default agent name for `synaptic-code run` (env: OPENCODE_DEFAULT_AGENT) */
...
export type SynapticCodeConfig = z.infer<typeof SynapticCodeConfigSchema>
