...
describe("loadJsonFile", () => {
  ...
  it("discovers JSONC-only user config (synaptic-code.jsonc)", () => {
  ...
  "lsp": {
    "user-jsonc": {
      ...
      const userPath = join(tempBase, "synaptic-code.jsonc")
  ...
  it("discovers JSONC-only project config (.opencode/synaptic-code.jsonc)", () => {
  ...
  "lsp": {
    "project-jsonc": {
      ...
      const projectPath = join(tempProject, ".opencode", "synaptic-code.jsonc")
  ...
  "lsp": {
    "conflict": {
      ...
      writeFileSync(join(tempBase, "synaptic-code.json"), jsonContent, "utf-8")
      writeFileSync(join(tempBase, "synaptic-code.jsonc"), jsoncContent, "utf-8")
