/**
 * Unified system directive prefix for synaptic-code internal messages.
 * All system-generated messages should use this prefix for consistent filtering.
 *
 * Format: [SYSTEM DIRECTIVE: SYNAPTIC-CODE - {TYPE}]
 */

export const SYSTEM_DIRECTIVE_PREFIX = "[SYSTEM DIRECTIVE: SYNAPTIC-CODE"

/**
 * Creates a system directive header with the given type.
 * @param type - The directive type (e.g., "TODO CONTINUATION", "RALPH LOOP")
 * @returns Formatted directive string like "[SYSTEM DIRECTIVE: SYNAPTIC-CODE - TODO CONTINUATION]"
 */
...
/**
 * Checks if a message starts with the synaptic-code system directive prefix.
