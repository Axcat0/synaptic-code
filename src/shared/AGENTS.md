...
Cross-cutting utilities used throughout the plugin. Barrel-exported from `index.ts`. Logger writes to `/tmp/synaptic-code.log`.
...
|---------|-------------|---------|
| `logger.ts` | 62 | `/tmp/synaptic-code.log` |
