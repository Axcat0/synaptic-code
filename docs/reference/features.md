# Synaptic-Code Features Reference

## Agents

Synaptic-Code provides 11 specialized AI agents. Each has distinct expertise, optimized models, and tool permissions.
...
Customize agent models, prompts, and permissions in `synaptic-code.json`.
...
You can define custom categories in `synaptic-code.json`.
...
Synaptic-Code provides two browser automation providers, configurable via `browser_automation_engine.provider`.
